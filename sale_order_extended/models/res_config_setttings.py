...
class SaleOrderExtendedSettings(models.TransientModel):
    ...
    sale_id = fields.Many2one(comodel_name="sale.order", string="Sale Order", config_parameter="sale.sale_id")
    dummy_field_c = fields.Many2one(related="sale_id.partner_id", readonly=False)
